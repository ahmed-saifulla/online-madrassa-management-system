...
export const AcademicYearsAPI = {
  list: (params) => apiRequest("/academic-years/", { params }),
  get: (id) => apiRequest(`/academic-years/${id}`),
  create: (data) => apiRequest("/academic-years/", { method: "POST", body: data }),
  update: (id, data) => apiRequest(`/academic-years/${id}`, { method: "PUT", body: data }),
...
export const StandardsAPI = {
  list: (params) => apiRequest("/standards/", { params }),
  get: (id) => apiRequest(`/standards/${id}`),
  create: (data) => apiRequest("/standards/", { method: "POST", body: data }),
  update: (id, data) => apiRequest(`/standards/${id}`, { method: "PUT", body: data }),
  delete: (id) => apiRequest(`/standards/${id}`, { method: "DELETE" }),
};
// api.js - Utility for Edu Management AP